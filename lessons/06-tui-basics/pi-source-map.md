...
| 界面区域组装 | [`interactive-mode.ts` L513-L558](https://github.com/earendil-works/pi/blob/1e95e16b61f4a561b932df83d58df52589e58635/packages/coding-agent/src/modes/interactive/interactive-mode.ts#L513) | `TuiState` + `TuiRenderer` | 保留 chat/editor/status/footer 的职责分区；教学版在每轮结束后打印一个纯文本帧，不做差分重绘。 |
